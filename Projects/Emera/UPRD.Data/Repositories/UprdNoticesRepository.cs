...
{
    public class UprdNoticesRepository : RepositoryBase<SwntPerTransaction>,IUprdNoticesRepository
    {
        public UprdNoticesRepository(IDbFactory dbfactory):base(dbfactory)
        {
    ...
    public interface IUprdNoticesRepository:IRepository<SwntPerTransaction>
    {
