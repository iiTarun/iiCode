  ...
  public  class ContractRepository : RepositoryBase<Contract>, IContractRepository
    {
        ...
        {
            var contract = this.DbContext.Contract.Where(a => a.RequestNo == SvcCnttNo && a.PipelineID == pipelineId).FirstOrDefault();
            return contract;
        }
    ...
    public interface IContractRepository : IRepository<Contract>
    {
        ...
        Contract GetContractByContractNo(string SvcCnttNo, int pipelineId);
