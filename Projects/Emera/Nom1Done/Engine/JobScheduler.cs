...
{
    public class JobScheduler : Ninject.Modules.NinjectModule
    {
        ...
        public static void Start()
        {
            ...
            #endregion
            #region Xml generation for location and counterparty
            CounterPartyAndLocationXmlGenerationJobCreation(_jobScheduler);
            #endregion
        }
        ...
        private static void NominationJobCreation(IScheduler _jobScheduler)
        {
            try
            {
                ...
                IJobDetail XMLGenerationJobDetail = JobBuilder.Create<JobManagerNomination>()
                                                    .WithIdentity(string.Format("{0}", "NominationJob"))
                                                    .Build();
        ...
        private static void CounterPartyAndLocationXmlGenerationJobCreation(IScheduler _jobScheduler)
        {
            try
            {
                Console.WriteLine("Nomination JobScheduler Start (check every 10 sec).");
                IJobDetail XMLGenerationJobDetail = JobBuilder.Create<GenerateXmlForLocationAndCounterParty>()
