   ...
   public class ContractService : IContractService
    {
        ...
        public IEnumerable<ContractsDTO> GetContracts(int pipeId, int companyId)
        {
            var allContracts = _IContractRepository.GetByPipeNShipper(IpipelineRepository.GetById(pipeId).DUNSNo, companyId).ToList();
        ...
        public Contract GetContractByContractNo(string SvcCnttNo, int pipelineId)
        {
            var contract = _IContractRepository.GetContractByContractNo(SvcCnttNo, pipelineId);
            return contract;
        }
