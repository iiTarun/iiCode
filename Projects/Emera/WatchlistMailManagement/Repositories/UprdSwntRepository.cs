...
namespace WatchlistMailManagement.Repositories
{
    public class UprdSwntRepository
    {
       ...
       public ModalFactory modalFactory;
        ...
        public IQueryable<SwntPerTransaction> SortByColumnWithOrder(IQueryable<SwntPerTransaction> dataQuery, SortingPagingInfo sortingPagingInfo)
        {
        ...
        {
            return dbcontext.SwntPerTransaction.Select(a => a.CreatedDate).OrderByDescending(a => a).FirstOrDefault();
        }
        ...
        {
            return dbcontext.SwntPerTransaction.Where(a => a.TransportationserviceProvider == DunsNo
                                  && (isCritical ? a.CriticalNoticeIndicator == "Y" : a.CriticalNoticeIndicator != "Y")
                                  && a.IsActive == true
        ...
        public BONotice GetNoticeById(int id)
        {
            ...
            SwntPerTransaction swnt = dbcontext.SwntPerTransaction.Where(a=>a.Id==id).FirstOrDefault();
