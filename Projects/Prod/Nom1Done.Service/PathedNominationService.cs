...
namespace Nom1Done.Service
{
    public class PathedNominationService : IPathedNominationService
    {
        ...
        {
            return NominationsRepository.GetPathedListTotalCount(PipelieID,Status,StartDate,EndDate,shipperDuns,loginUser);
        }
        ...
        {
            return NominationsRepository.GetPathedListWithPaging(PipelieID,Status,StartDate,EndDate,shipperDuns,loginUser,sortingPagingInfo);
        }
        ...
        {
            return NominationsRepository.GetPathedList(PipelieID, Status, StartDate, EndDate, shipperDuns, loginUser);
