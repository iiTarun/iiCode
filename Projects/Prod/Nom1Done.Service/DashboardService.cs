...
namespace Nom1Done.Service
{
    public class DashboardService : IDashboardService
    {
        ...
        public IEnumerable<RejectedNomModel> GetRejectedNomination(int pipelineId,string userId)
        {
            return nominationRepository.GetAllRejectedNoms(pipelineId,userId);
        }
