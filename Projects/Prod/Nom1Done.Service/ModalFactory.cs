...
namespace Nom1Done.Service
{
    public class ModalFactory : IModalFactory
    {
        ...
        public BatchDetailDTO Parse(V4_Batch batch,IEnumerable<V4_Nomination> nomList)
        {
            ...
            if (batch != null)
            {
                Pipeline pipe = pipelineRepository.GetById(batch.PipelineID);
                ...
                if (nomList != null)
                {
                    ...
                    if (supList != null)
                        foreach (var item in supList)
                        {
                            ...
                            CounterParty counterParty = CounterPartyRepository.GetAll().Where(a => a.Identifier == item.UpstreamIdentifier && (a.PipelineID == batch.PipelineID || a.PipelineID == 0)).FirstOrDefault();
                            Contract con = contractRepository.GetAll().Where(a => a.RequestNo == item.ContractNumber && a.PipelineID == batch.PipelineID).FirstOrDefault();
                            ...
                            supplyObj.LocationName = locRec != null ? locRec.Name : "";
                            ...
                            supplyObj.UpstreamIDName = counterParty != null ? counterParty.Name : "";
                    ...
                    if (tranList != null)
                        foreach (var item in tranList)
                        {
                            ...
                            Contract con = contractRepository.GetAll().Where(a => a.RequestNo == contractNumber && a.PipelineID == batch.PipelineID).FirstOrDefault();
                            if (con != null)
                            {
                                ...
                                contractObj.RecLocationName = locRec != null ? locRec.Name : "";
                                ...
                                contractObj.DelLocationName = locDel != null ? locDel.Name : "";
                    ...
                    if (marList != null)
                        ...
                        { 
                            CounterParty counterParty = CounterPartyRepository.GetAll().Where(a => a.Identifier == item.DownstreamIdentifier && (a.PipelineID == batch.PipelineID || a.PipelineID == 0)).FirstOrDefault();
                            Location locDel = locationRepository.GetAll().Where(a => (a.Identifier == item.DeliveryLocationIdentifer && a.PipelineID == batch.PipelineID) || (a.Identifier == item.DeliveryLocationIdentifer && a.PipelineID == batch.PipelineID)).FirstOrDefault();
                            List<metadataTransactionType> tranType = metadataTransactionTypeRepository.GetAll().Where(a => (a.Identifier == item.TransactionType)).ToList();
                            Contract con = contractRepository.GetAll().Where(a => a.RequestNo == item.ContractNumber && a.PipelineID == batch.PipelineID).FirstOrDefault();
                            metadataRequestType reqType = null;
                            if (con != null)
                            ...
                            marketObj.LocationName = locDel != null ? locDel.Name : "";
                            ...
                            marketObj.DownstreamIDName = counterParty != null ? counterParty.Name : "";
        ...
        public BatchDTO Parse(V4_Batch batch)
        {
            ...
            itemObj.PipelineId = batch.PipelineID;
            ...
            itemObj.pipeDUNSNo = pipe != null ? pipe.DUNSNo : string.Empty;
