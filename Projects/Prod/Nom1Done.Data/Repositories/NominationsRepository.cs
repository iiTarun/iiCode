...
namespace Nom1Done.Data.Repositories
{
    public class NominationsRepository : RepositoryBase<V4_Nomination>, INominationsRepository
    {
        ...
        public IEnumerable<BatchDTO> GetAllNonPathedNominationBatch()
        {
            try
            {
                ...
                var batchs = (from a in this.DbContext.V4_Batch
                              ...
                              where a.NomTypeID == (int)NomType.NonPathed   // only PNT batches
    ...
    public interface INominationsRepository : IRepository<V4_Nomination>
    {
        ...
        NonPathedDTO GetNonPathedNominations(int PipelieID, int Status, DateTime StartDate, DateTime EndDate, string shipperDuns, Guid loginUser, Guid TransactionId);
        ...
        IEnumerable<BatchDTO> GetAllNonPathedNominationBatch();
    }
}
