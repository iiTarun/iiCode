...
namespace WatchlistMailManagement.Repositories
{
    public class UprdUnscRepository
    {
        ...
        public IQueryable<UnscPerTransactionDTO> GetUnscData(IQueryable<UnscPerTransaction> result)
        {
            ...
            join l in dbcontext.Location on u.TransactionServiceProvider equals l.PipeDuns into unsc
            from unscResult in unsc.Where(x => x.PropCode == u.Loc).DefaultIfEmpty()
                    ...
                    select new UnscPerTransactionDTO
                    {
                           ...
                           PostingDateTime =u.PostingDateTime,
                           EffectiveGasDayTime=u.EffectiveGasDayTime,
        ...
        public IQueryable<UnscPerTransactionDTO> SortByColumnWithOrder(IQueryable<UnscPerTransactionDTO> dataQuery,SortingPagingInfo sortingPagingInfo)
        {
                ...
                switch (sortingPagingInfo.SortField)
                {
                    ...
                    case "EffectiveGasDay":
                        dataQuery = orderDir.Equals("DESC", StringComparison.CurrentCultureIgnoreCase) ? dataQuery.OrderByDescending(p => p.EffectiveGasDayTime)
                                                                                                 : dataQuery.OrderBy(p => p.EffectiveGasDayTime);
                        break;
        ...
        public IQueryable<UnscPerTransaction> GetRecentUnscByPostDate(string pipelineDuns, DateTime? postDate)
        {
            ...
            return dbcontext.UnscPerTransaction.Where(a => a.TransactionServiceProvider == pipelineDuns && DbFunctions.TruncateTime(a.PostingDateTime) == pDate);
        }
        ...
        {        
           var unsclist = dbcontext.UnscPerTransaction.Where(a => a.TransactionServiceProvider == pipelineDuns
