...
namespace Nom1Done.Controllers
{
    ...
    public class SQTSSummaryController : BaseController
    {
       ...
       // IPipelineService _pipelineService;
        ...
        public PartialViewResult SQTSPartials(SqtsPartials sqts, int month, string sqtsType, string pipelineDuns, bool showMine,bool showZero, int? page)
        {
            int pageSize = 20;
            ...
            switch (sqts)
            {
                case SqtsPartials.NomQty:
                    ...
                    model = _nomRepo.GetAcceptedNomsOnDate(month, pipelineDuns, UserId, currentIdentityValues.ShipperDuns, sqtsType == "loc" ? true : false, showZero);
                    break;
                case SqtsPartials.SqtsQty:
                    ViewBag.PathType = "P";
                    ViewBag.IsSqtsQty = "true";
                    PartialName = "_sqtsOrphanCom";
                    List<SummaryDTO> list = _sqtsRepo.GetSqtsData(month, pipelineDuns, UserId, "P", currentIdentityValues.ShipperDuns,showZero, pageSize, page.Value);
                ...
                case SqtsPartials.SqtsOrphan:
                    ...
                    ViewBag.PathType = "P";
                    List<SummaryDTO> listO = _sqtsRepo.GetSqtsOrphanData(month, pipelineDuns, "P", currentIdentityValues.ShipperDuns, showZero, pageSize, page.Value);
                    listO = UpdateCounterPartyName(listO);
                    model = listO;
                    break;
                case SqtsPartials.NomQtyDelivery:
                    PartialName = "_NomQtyDeliveryPartial";
                    model = _nomRepo.GetAcceptedNomOnDate(month, "D", pipelineDuns, UserId, currentIdentityValues.ShipperDuns, sqtsType == "loc" ? true : false, showZero);
                    break;
                case SqtsPartials.NomQtyReceipt:
                    PartialName = "_NomQtyReceiptPartial";
                    model = _nomRepo.GetAcceptedNomOnDate(month, "R", pipelineDuns, UserId, currentIdentityValues.ShipperDuns, sqtsType == "loc" ? true : false, showZero);
                    break;
                ...
                case SqtsPartials.SqtsOrphanDelivery:
                    ...
                    ViewBag.IsSqtsQty = "false";
                    PartialName = "_sqtsOrphanCom";
                    List<SummaryDTO> listDO = _sqtsRepo.GetSqtsOrphanData(month, pipelineDuns, "D", currentIdentityValues.ShipperDuns, showZero, pageSize, page.Value);
                ...
                case SqtsPartials.SqtsOrphanReceipt:
                    ...
                    ViewBag.IsSqtsQty = "false";
                    PartialName = "_sqtsOrphanCom";
                    List<SummaryDTO> listRO = _sqtsRepo.GetSqtsOrphanData(month, pipelineDuns, "R", currentIdentityValues.ShipperDuns, showZero, pageSize, page.Value);
                ...
                case SqtsPartials.SqtsQtyDelivery:
                    ...
                    ViewBag.IsSqtsQty = "true";
                    PartialName = "_sqtsOrphanCom";
                    List<SummaryDTO> listD = _sqtsRepo.GetSqtsData(month, pipelineDuns, UserId, "D", currentIdentityValues.ShipperDuns, showZero, pageSize, page.Value);
                ...
                case SqtsPartials.SqtsQtyReceipt:
                    ...
                    ViewBag.IsSqtsQty = "true";
                    PartialName = "_sqtsOrphanCom";
                    List<SummaryDTO> listR = _sqtsRepo.GetSqtsData(month, pipelineDuns, UserId, "R", currentIdentityValues.ShipperDuns, showZero, pageSize, page.Value);
                    listR = UpdateCounterPartyName(listR);
                    model = listR;
                    break;
                case SqtsPartials.NomQtyContractPath:
                    PartialName = "__NomQtyContractPathPartial";
                    model = _nomRepo.GetNomQtyForContractPath(month, pipelineDuns, UserId, currentIdentityValues.ShipperDuns, sqtsType == "loc" ? true : false, showZero);
                    break;
                case SqtsPartials.SqtsOrphanContractPath:
                    ViewBag.PathType = "T";
                    ViewBag.IsSqtsQty = "false";
                    PartialName = "_sqtsOrphanCom";
                    List<SummaryDTO> listCO = _sqtsRepo.GetSqtsOrphanData(month, pipelineDuns, "T", currentIdentityValues.ShipperDuns, showZero, pageSize, page.Value);
                ...
                case SqtsPartials.SqtsQtyContractPath:
                    ...
                    ViewBag.IsSqtsQty = "true";
                    PartialName = "_sqtsOrphanCom";
                    List<SummaryDTO> listC = _sqtsRepo.GetSqtsData(month, pipelineDuns, UserId, "T", currentIdentityValues.ShipperDuns, showZero, pageSize, page.Value);
        ...
        public ActionResult DownloadExcel(string pipelineDuns,int month, string pathType,string IsSqtsQty, bool showMine, bool showZero)
        {
            try
            {
                ...
                if (Convert.ToBoolean(IsSqtsQty))
                {
                    list = _sqtsRepo.GetAllSqtsData(month, pipelineDuns, UserId, pathType, currentIdentityValues.ShipperDuns, showZero);
                    list = UpdateCounterPartyName(list);
                ...
                {
                    list = _sqtsRepo.GetAllSqtsOrphanData(month, pipelineDuns, pathType, currentIdentityValues.ShipperDuns, showZero);
                    list = UpdateCounterPartyName(list);
                ...
                for (int j = 0; j < dt.Columns.Count; j++)
                {
                    ...
                    if (columnName.Trim() != "SubmittedDate" && columnName.Trim() != "Username" && columnName.Trim() != "Qty")
                    {
                ...
                for (int i = 0; i < dt.Rows.Count; i++)
                {
                    ...
                    for (int j = 0; j < dt.Columns.Count; j++)
                    {
                        ...
                        if (columnName.Trim() != "SubmittedDate" && columnName.Trim() != "Username" && columnName.Trim() != "Qty")
                        {
                            ...
                            {
                                string formula = "VLOOKUP(K" + (i + 2) + ",CP!A1:B5000,2,0)";
