...
namespace Nom1Done.Controllers
{
   [Authorize]
    public class PNTNominationsController : BaseController
    {
        ...
        public PartialViewResult DynamicTabs(List<TestNomSupply> SupplyRecords, List<TestNomTransport> TransportRecords, List<TestNomMarket> MarketRecords, string tab, string PipelineDuns)//tab = 1 for Batch, 2 for NomMatrix, 3 for Supply, 4 for Market
        {
            try
            {
                if (tab == "1")
        ...
        public ActionResult Index(Guid BatchId, string pipelineDuns)
        {
            ViewBag.Status = "";
            ...
            batchdetailModel = IPNTNominationService.GetNomDetail(BatchId, pipelineDuns);
            ...
            batchdetailModel.PipelineModelType = GetPathTypeByPipelineType(pipe.ModelTypeID);

            if (batchdetailModel.PipelineModelType == NomType.HyPathedPNT && batchdetailModel.BatchNomType == 1)
            {
                DateTime todayDate = DateTime.Now.Date;

                int status = 0;
                int pathedListTotalCount = _pathedNominationService.GetPathedListTotalCount(batchdetailModel.Duns, status, DateTime.MinValue, DateTime.Now.AddYears(1), currentIdentityValues.ShipperDuns, new Guid(currentIdentityValues.UserId));

                List<PathedNomDetailsDTO> nomlist = _pathedNominationService.GetPathedListWithPaging(batchdetailModel.Duns, status, DateTime.MinValue, DateTime.Now.AddYears(1), currentIdentityValues.ShipperDuns, new Guid(currentIdentityValues.UserId), new SortingPagingInfo() { CurrentPageIndex = 0, PageSize = pathedListTotalCount });
            ...
            batchdetailModel.Duns = pipelineDuns;
            batchdetailModel.PipeLineName = pipe.Name;
        ...
        public ActionResult Index(BatchDetailDTO model, string send)
        {
            ...
            if (send == null)
            {
                ...
                if (data != null)
                {
                    ...
                    return RedirectToAction("Index", new { BatchId = model.Id, pipelineDuns = model.Duns });
                }
                else
                {
            ...
            {    //TODO
                ...
                if (isSend)
                {
                    ...
                    return RedirectToAction("Index", "Batch", new { pipelineDuns = model.Duns });
                }
                else
                {
        ...
        {
            var pipelinename= model.PipeLineName;
            model = IPNTNominationService.GetNomDetail(model.Id, model.Duns);
        ...
        public ActionResult LoadHybridPathedPartial(BatchDetailDTO model)
        {
            ...
            ShipperReturnByIdentity currentIdentityValues = GetValueFromIdentity();           
            int status = -1;        
            int pathedListTotalCount = _pathedNominationService.GetPathedListTotalCount(model.Duns, status, DateTime.MinValue, DateTime.Now.AddYears(1), currentIdentityValues.ShipperDuns, new Guid(currentIdentityValues.UserId));
         
            List<PathedNomDetailsDTO> nomlist = _pathedNominationService.GetPathedListWithPaging(model.Duns, status, DateTime.MinValue, DateTime.Now.AddYears(1), currentIdentityValues.ShipperDuns, new Guid(currentIdentityValues.UserId), new SortingPagingInfo() { CurrentPageIndex=0, PageSize = pathedListTotalCount});
        ...
        public ActionResult LoadHybridNonPathedPartial(BatchDetailDTO model)
        {
            ...
            ShipperReturnByIdentity currentIdentityValues = GetValueFromIdentity();
            int status = -1;
            var  data = nonPathedService.GetNonPathedNominations(model.Duns, status, DateTime.MinValue, DateTime.MaxValue, currentIdentityValues.ShipperDuns, new Guid(currentIdentityValues.UserId));
        ...
        public ActionResult SaveNonPathedHybrid(BatchDetailDTO Mainmodel)
        {
            ...
            model.PipelineDuns = Mainmodel.Duns;
           ...
           // model.PipelineDuns = pipe.DUNSNo;
            ...
            return RedirectToAction("Index", new { BatchId = Mainmodel.Id, pipelineDuns = Mainmodel.Duns });
        }
        ...
        public ActionResult PathedHybrid(BatchDetailDTO Mainmodel)
        {
            ...
            if (model.PathedNomsList == null)
            {
                ...
                return RedirectToAction("Index", new { BatchId = Mainmodel.Id, pipelineDuns = model.DunsNo });
            }
        ...
        public PartialViewResult AddContractPathRow(string pipelineDuns, string TableID)
        {
            BatchDetailDTO model = new BatchDetailDTO();
            model.Duns = pipelineDuns;
        ...
        public PartialViewResult AddContractTransportPath(string pipelineDuns)
        {
            BatchDetailDTO model = new BatchDetailDTO();
            model.Duns = pipelineDuns;
        ...
        public PartialViewResult AddMarketRow(string pipelineDuns)
        {
            BatchDetailDTO model = new BatchDetailDTO();
            model.Duns = pipelineDuns;
            //model.Duns = pipelineService.GetDunsByPipelineID(PipelineID);
        ...
        public PartialViewResult AddSupplyRow(string pipelineDuns)
        {
            BatchDetailDTO model = new BatchDetailDTO();
            model.Duns = pipelineDuns;
            //model.Duns = pipelineService.GetDunsByPipelineID(PipelineID);
