...
namespace Nom1Done.Data.Repositories
{
    public class metadataTransactionTypeRepository : RepositoryBase<metadataTransactionType>, ImetadataTransactionTypeRepository
    {
        ...
        public metadataTransactionType GetTTUsingIdentifier(string TTIdentifier, string pathType, string pipelineDuns)
        {
            var tt= DbContext.metadataTransactionType.Where(a => a.IsActive
                    && a.Identifier == TTIdentifier
                    && DbContext.Pipeline_TransactionType_Map.Any(b => b.IsActive && b.PipeDuns == pipelineDuns && b.PathType.Trim() == pathType && b.TransactionTypeID == a.ID)).FirstOrDefault();           
            return tt;
        }
    ...
    public interface ImetadataTransactionTypeRepository:IRepository<metadataTransactionType>
    {
        ...
        metadataTransactionType GetTTUsingIdentifier(string TTIdentifier, string TTfrom, string pipelineDuns);
