...
namespace Nom1Done.Data.Repositories
{
    public class SQTSRepository : RepositoryBase<SQTSPerTransaction>, ISQTSRepository
    {
        ...
        public List<SummaryDTO> GetAllSqtsOrphanData(int month, string pipeDuns, string pathType, string shipperCompanyDuns, bool showZero)
        {
            ...
            if (!showZero)
            {
                if (pathType == "P")
                {
                    var sqtsList = DbContext.SQTSPerTransaction.Where(sqts =>
                                ...
                                sqts.ModelType == "P" &&
                                sqts.NomTrackingId.Trim().Contains("N/A") &&
        ...
        public List<SummaryDTO> GetAllSqtsData(int month, string pipeDuns, string UserId, string pathType, string shipperCompanyDuns, bool showZero)
        {
    ...
    public interface ISQTSRepository : IRepository<SQTSPerTransaction>
    {
        ...
        List<SummaryDTO> GetAllSqtsOrphanData(int month, string pipeDuns, string pathType, string shipperCompanyDuns, bool showZero);
        List<SummaryDTO> GetAllSqtsData(int month, string pipeDuns, string UserId, string pathType, string shipperCompanyDuns, bool showZero);
